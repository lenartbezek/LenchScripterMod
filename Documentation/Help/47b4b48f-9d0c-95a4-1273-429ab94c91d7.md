# LuaMethodWrapper.getCenterOfMass Method 
 

Returns the center of mass of the block, relative to the block's position. Throws NoRigidBodyException if the block has no RigidBody.
