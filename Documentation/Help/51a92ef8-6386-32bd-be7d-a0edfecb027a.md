# ScripterMod.BesiegeVersion Property 
 

\[Missing <summary> documentation for "P:LenchScripterMod.ScripterMod.BesiegeVersion"\]
...
**C#**<br />
``` C#
public override string BesiegeVersion { get; }
```
